...
/**
 * Your "mapper" library manages the conversion of java.util.Map into a JSON
 * format string.
 * Problem: The RunAdapter application is able to write java.util.Map to a JSON
 * file.
 * You will need to teach it to write the java.util.Map to an XML file.
 * You found out that there is a converter library that can handle this task,
